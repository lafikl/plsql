...
type PlSqlParserListener interface {
	...
	// EnterRelational_properties is called when entering the relational_properties production.
	EnterRelational_properties(c *Relational_propertiesContext)
	...
	// ExitRelational_properties is called when exiting the relational_properties production.
	ExitRelational_properties(c *Relational_propertiesContext)
