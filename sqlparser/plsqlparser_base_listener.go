...
// EnterRelational_properties is called when production relational_properties is entered.
func (s *BasePlSqlParserListener) EnterRelational_properties(ctx *Relational_propertiesContext) {}

// ExitRelational_properties is called when production relational_properties is exited.
func (s *BasePlSqlParserListener) ExitRelational_properties(ctx *Relational_propertiesContext) {}
